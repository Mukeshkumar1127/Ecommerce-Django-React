...
const UserInfo = ({userInfo}) => {
  return (
    ...
    <div className={`col-md-3 py-3 card ${styles.textCenter}`}>
      ...
      <button className="btn  mt-2" style={{ backgroundColor: '#4CAF50', color: 'white' }}>Edit Profile</button>
    </div>
    <div className="col-md-9">
      <div className="card">
        <div className="card-header" style={{ backgroundColor: '#4CAF50', color: 'white' }}>
